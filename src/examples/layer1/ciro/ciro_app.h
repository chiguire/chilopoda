...
namespace octet {
  ...
  public:
    ...
    void set_relative(lebox &rhs, float x, float y) {
    ...
    bool collides_with(const lebox &rhs) const {
  ...
  class ciro_app : public octet::app {
  ...
  public:
    ...
    ciro_app(int argc, char **argv) : app(argc, argv) {
    }
